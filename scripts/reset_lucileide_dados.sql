...
--
-- Este script NÃO está na pasta migrations/ propositalmente.
-- Deve ser executado MANUALMENTE quando quiser zerar todos os dados
-- da empresa piloto para reiniciar do zero.
-- ================================================================
